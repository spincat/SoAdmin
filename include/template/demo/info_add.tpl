...
<div class="well well-sm form-well">
    <ul class="nav nav-tabs">
      <li class="active"><a href="#home">请填写信息</a></li>
    </ul>	
	...
	<div id="myTabContent" class="tab-content">
        ...
        <div class="form-group">
					<label>发布时间</label>
					<input type="text" id="publish_date" name="date" value="<{$_POST.date}>" class="form-control" required="true">
				</div>
        <div class="form-group">
					<label>作者</label>
					<input type="text" name="user" value="<{$user}>" class="form-control" disabled>
				</div>
        
        <input class="img-url hidden-field" type="text" name="imgurl">
        ...
        <div class="form-group">
					...
					<textarea class="input-xlarge limit-input" name="cont" maxwords="90" style="width:600px;height:100px;" required="true" placeholder="输入长度在90字以内" value="<{$_POST.cont}>"></textarea>
				</div>
				<div class="form-group">
					<label>来自</label>
					<input type="text" name="source" value="<{$_POST.source}>" class="form-control" required="true">
				</div>
