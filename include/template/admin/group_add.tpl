		  ...
		  <div class="tab-pane active in" id="home">
           ...
           <form id="tab" method="post" action="">
				<div class="form-group">
					<label>账号组名称</label>
					<input type="text" name="group_name" value="<{$_POST.group_name}>" class="form-control" required="true" autofocus="true" >
				</div>
				<div class="form-group">
					<label>描述</label>
					<textarea name="group_desc" rows="3" class="form-control"><{$_POST.group_desc}></textarea>
				</div>
