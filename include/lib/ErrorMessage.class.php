...
class ErrorMessage {
	...
	const ALIAS_CONFLICT ="别名冲突";
	const TITLE_CONFLICT ="标题已存在";
	const DATE_CONFLICT ="该日记录已存在";
	const INFOCODE_CONFLICT ="信息编码已存在";
	const MENU_URL_CONFLICT ="链接地址冲突";
	const IMAGE_CONFLICT ="图片已存在";
	...
	const NEWS_TYPE_NOT_EXIST 	="资讯类别不存在";
	const NEWS_NOT_EXIST 	="资讯不存在";
	const MEDIA_TYPE_NOT_EXIST 	="影音类别不存在";
	const MEDIA_NOT_EXIST 	="影音不存在";
	const DOC_TYPE_NOT_EXIST 	="文集类别不存在";
	const DOC_NOT_EXIST 	="文集不存在";
	const BOOK_TYPE_NOT_EXIST 	="图书类别不存在";
	const BOOK_NOT_EXIST 	="图书不存在";
	const MAXIM_NOT_EXIST 	="教言不存在";
	const BANNER_NOT_EXIST 	="横幅不存在";
}
